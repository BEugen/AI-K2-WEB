...
function drawchart(a,b,c,d){c.yaxes[0].min=0;c.yaxes[0].max=24.5;3>a&&(c.yaxes[0].min=0,c.yaxes[0].max=8.5);$.plot("#"+b,[d[0],d[1],d[2],d[3],d[4],d[5]],c)}
function drawinfo(a,b){$("#cam").css("background-image","url(data:image/jpeg;base64,"+a.img+")");$("#cam-label").text("\u0414\u0430\u0442\u0430 "+a.tstamp);if(.95<a.stop&&1!==a.snnclass)$("#img").css("box-shadow","0 0 40px #759ebf");else if(a.full<a.empty&&1!==a.snnclass)$("#img").css("box-shadow","0 0 25px 2px #666d6e");else switch(a.snnclass){case 0:$("#img").css("box-shadow","0 0 25px 2px #666d6e");break;case 1:$("#img").css("box-shadow","0 0 25px 2px #f20855");break;case 2:$("#img").css("box-shadow",
...
function setstat(a,b){for(var c=0;c<a.length&&4>c;c++){var d="ch_";d=3>c?d+c:d+"all";var e=a[c];drawstattable(c,d,e);b.yaxes[0].min=0;b.yaxes[0].max=a[4][0][1];3>c&&(b.yaxes[0].min=0,b.yaxes[0].max=a[4][0][0]);$.plot("#"+d,[e[0],e[1],e[2],e[3],e[4],e[5]],b)}}
function getprotocol(a,b,c,d){astat=$.ajax({url:a,data:{dt:c,dr:d,csrfmiddlewaretoken:b},timeout:1E5,type:"POST",beforeSend:function(){$("#wait").show()},success:function(a){$("#wait").hide();protocolview(a)},error:function(){$("#wait").hide()}})}
